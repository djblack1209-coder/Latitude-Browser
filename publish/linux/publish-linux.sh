...
echo "========================================"
echo "  Latitude Browser Linux Publish"
echo "========================================"
echo "Target : $TARGET"
...
mkdir -p "$OUTPUT_DIR"
TAR_NAME="LatitudeBrowser-${VERSION}-linux-${ARCH}.tar.gz"
...
<component type="desktop-application">
  ...
  <description>
    <p>Latitude Browser manages isolated browser profiles, proxy binding, and local environment configuration for multi-account workflows.</p>
...
Description: ${APP_NAME} desktop app
 ...
 Latitude Browser manages isolated browser profiles, proxy binding, and
